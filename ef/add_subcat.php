  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li><a href="contact.php"><i class="icon-comments"></i><span>Contatt</span> </a> </li>
        ...
        <div class="widget ">
           ...
           <div class="tabbable">
            ...
            <ul class="nav nav-tabs">
              <li  class="active">
              <li ><a href="#jscontrols" data-toggle="tab">Add Sub-Category</a></li>
              </li>
            </ul>
            <br>
              ...
              <div class="tab-content">
                    ...
                    <fieldset>
                      ...
                      <label class="control-label">Choose Main Category </label>
                                                        ...
                                                        <label class="control-label">Sub-Category Name</br></label>
                                                          <div class="controls">
                                                           <input type="text" class="span6" name="scat" placeholder="Sub-Category">
                                                              <input name="ssubmit" value="&#10004;" type="submit" style="color:blue;"/>
                                                                 </div> <!-- /controls -->       
                                                                  </div> <!-- /control-group -->
                                                                </form>
                                                                     </div>
                ...
                <form id="edit-profile" class="form-horizontal"  action="add_subcat.php" method="POST" enctype="multipart/form-data">
                  <fieldset>     
                  <div class="left">               
                    <div class="control-group">                     
