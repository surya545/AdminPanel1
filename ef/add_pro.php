        ...
        <div class="widget ">
           ...
           <div class="tabbable">
            ...
            <ul class="nav nav-tabs">
              <li  class="active">
              <li ><a href="#products" data-toggle="tab">Add Products</a></li>
              </li>
            </ul>
            <br>
              ...
              <div class="tab-content">
                ...
                <form id="edit-profile" class="form-horizontal"  action="add_pro.php" method="POST">
                  <fieldset>                    
                ...
                <form id="edit-profile" class="form-horizontal"  action="add_pro.php" method="POST" enctype="multipart/form-data">
                  <fieldset>     
                  <div class="left">               
                    <div class="control-group">                     
                      ...
                      <div class="controls"><div id="txtHint">
                        ...
                        <div class="controls">
                        <input type="text" class="span6" name="proname" placeholder="Product Name">
                      </div>
