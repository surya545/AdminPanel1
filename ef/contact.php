                    ...
                    <?php   
                          if(isset($_POST["isubmit"]))
                          {
                            $getuploadfiles="";
                             ...
                             $query2 = mysql_query("insert into contact(cont) values ('$_POST[Editor1]')");
                            }
                          ?>
<html lang="en">
...
<div class="main">
	...
	<div class="main-inner">
	    ...
	    <div class="container">
                ...
                <form id="edit-profile" class="form-horizontal"  action="contact.php" method="POST" enctype="multipart/form-data">
	      <div class="row">
