                    ...
                    <?php   
                          if(isset($_POST["isubmit"]))
                          {
                            $getuploadfiles="";
                             ...
                             $query2 = mysql_query("insert into testimonials(test,img) values ('$_POST[Editor1]','$getuploadfiles')");
                            }
                          ?>
<html lang="en">
	...
	<div class="main-inner">
	    ...
	    <div class="container">
	  	  ...
	  	  <!-- /row -->
                ...
                <form id="edit-profile" class="form-horizontal"  action="testimonial.php" method="POST" enctype="multipart/form-data">
	      <div class="row">
